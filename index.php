<?php include("header.php"); ?>
			      		...
			      		<div class="carousel-item slide active">
		                    ...
		                    <div class="slide-article">
		                    	<div class="carousel-article-container">
				                    <h2>
				                        Evangelization sur tout le territoire 
				                    </h2>
				                    <p>
				                    ...
				                    <div class="carousel-btn-container">
					                    <div class="btn-carousel"><a href="#">SAVOIR PLUS</a></div>
					                    <div class="btn-carousel btn-2"><a href="#">ME CONCERNANT</a></div>
				                	</div>
			                    </div>
		                    </div>
	                	</div>
	...
	<section class="row parallax-container">
