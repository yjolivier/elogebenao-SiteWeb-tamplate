<?php include("header.php"); ?>
					      		...
					      		<div class="carousel-item slide active">
				                    ...
				                    <div class="slide-article">
				                    	<div class="article-content">
						                    <h2>
						                        Evangelization sur tout le territoire national.
						                    </h2>
						                    <p>
						                    ...
						                    <div class="row">
							                    <div class="btn-carousel col"><a href="#">SAVOIR PLUS</a></div>
							                    <div class="btn-carousel col"><a href="#">ME CONCERNANT</a></div>
						                	</div>
					                    </div>
				                    </div>
			                	</div>
			...
			<section class="section-evenement row">
					<div class="section-evenement-title col-md-12 col-lg-12 col-sm-12">
						<h2>ACTUALITE</h2>
						<P>
							Tout sur mes activité du moment.
						</P>
					</div>
				</center>
			...
			<section class="row">
				<div class="parallax col-lg-12">
					<div class="parallax-article row">
						<h2 class="col-lg-12">BIOGRAPHIE</h2>
